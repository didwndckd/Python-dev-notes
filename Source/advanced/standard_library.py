...
# **: 하위 디렉터리 전체, recursive=True를 함께 줘야 모든 깊이를 의미한다. 예) Source/**/*.py
# 주의
...
paths = glob.glob("Source/*.py")
print(paths) # ['Source/hello_vscode.py']

# Source 하위 디렉터리의 .py 반환
paths = glob.glob("Source/datatype/*.py")
print(paths) # ['Source/datatype/tuple.py', 'Source/datatype/list.py', 'Source/datatype/bool.py', 'Source/datatype/numbers.py', 'Source/datatype/variable.py', 'Source/datatype/string.py', 'Source/datatype/dictionary.py', 'Source/datatype/set.py']

# Source 아래 모든 깊이의 .py 반환
paths = glob.glob("Source/**/*.py", recursive=True)
print(paths) # ['Source/hello_vscode.py', 'Source/advanced/built_in_function.py', 'Source/advanced/class.py', 'Source/advanced/handle_exception.py', 'Source/advanced/standard_library.py', 'Source/control/for.py', ..., 'Source/packages/main/package.py'] -> 총 30개
...
#   File "/Users/yjc/Workspace/Python-dev-notes/Source/standard_library.py", line 448, in main
#     b()
#     ~^^
#   File "/Users/yjc/Workspace/Python-dev-notes/Source/standard_library.py", line 445, in b
#     a()
#     ~^^
#   File "/Users/yjc/Workspace/Python-dev-notes/Source/standard_library.py", line 443, in a
#     return 1/0
#            ~^~
